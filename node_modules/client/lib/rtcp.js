...
Client.prototype.listen=function(port){
   console.log('adapter has linster port %d', port);
    var client=this;
    ...
    srv.listen(port,function(){
        console.log(' rtcp client listening on port %d', port);
    });
    srv.on('error', function(e) {
        console.error(' rtcp client listen on port:'+port+' error:'+e);
    });
}
Client.prototype.send=function(data){
    var client=this;
    console.log('current socket number:',client.socks.length);
