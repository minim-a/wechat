...
Wechat.getMediaImg2Base64=function(mediaId){
    let that=this;
    return new Promise(function (resolve,reject) {
        that.fetchAccessToken()
            ...
            .then(function (data) {
                let access_token=that.access_token;
                let url='http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=ACCESS_TOKEN&media_id=MEDIA_ID';
                url=url.replace('ACCESS_TOKEN',access_token).replace('MEDIA_ID',mediaId);
                http.get(url, function (req, res) {
                    ...
                    req.on('end', function (data) {
                        ...
                        if ('image/jpeg' === type){
                            ...
                            let base64str =imgBuffer.toString('base64');
                            base64str=prefix+base64str;
                            resolve(base64str);
                        }else{
                            reject(" Not a JPG file");
                        }
                ...
                //         let base64str = Buffer.from(body, 'binary').toString('base64')
                //         let imgBase64=prefix+base64str;
